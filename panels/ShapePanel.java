...
public class ShapePanel extends JPanel {
	...
	public ShapePanel() {
		...
		circle_label = new MyLabel(new ImageIcon("src/main/java/icons/circle.png"));
		circle_label.setName("circle");
		//circle_label.setBounds(13, 50, 124, 124);
		this.add(circle_label);
		
		rectangle_label = new MyLabel(new ImageIcon("src/main/java/icons/rectangle.png"));
		//rectangle_label.setBounds(13, 50, 124, 124);
		rectangle_label.setName("rectangle");
		this.add(rectangle_label);
		
		triangle_label = new MyLabel(new ImageIcon("src/main/java/icons/triangle.png"));
		//triangle_label.setBounds(13, 50, 124, 124);
		triangle_label.setName("triangle");
		this.add(triangle_label);
		
		polygon_label = new MyLabel(new ImageIcon("src/main/java/icons/polygon2.png"));
